   ...
   // Generate a new number (in this ase it's 2)
   function generate() {
   ...
   // Functions for movement and merging 
   // 'Zeros' represent the empty squares
   function moveRight() {
      for (let i=0; i < 16; i++) {
         if (i % 4 === 0) {
   ...
   // Check if there are no zeros (empty squares) on the board to lose
